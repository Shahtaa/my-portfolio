...
const TelegramIcon = () => (
  <SvgIcon>
    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.92 6.01l-1.73 8.16c-.13.59-.48.73-.97.45l-2.69-1.98-1.29 1.25c-.14.14-.26.26-.54.26l.19-2.75 5.01-4.54c.22-.19-.05-.3-.34-.11l-6.24 3.93-2.69-.84c-.58-.18-.59-.58.12-.85l10.47-4.04c.48-.17.91.11.75.85z" />
  </SvgIcon>
);
